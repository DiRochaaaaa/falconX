...
// Ícones do sistema como constantes reutilizáveis
export const Icons = {
  // Dashboard - Gráfico de barras
  Dashboard: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Domínios - Globo/Internet
  Globe: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Ações - Raio
  Lightning: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Fechar/X
  X: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Alerta/Warning
  Warning: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Sucesso/Check
  Check: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Menu Hamburger
  Menu: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Loading Spinner
  Spinner: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
  ...
  // Seta para direita
  ArrowRight: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Olho fechado
  EyeOff: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
  ...
  // Atualizar/Refresh
  RefreshCw: ({ className = 'h-5 w-5', size }: IconProps) => (
    <svg
      className={className}
      width={size}
      height={size}
